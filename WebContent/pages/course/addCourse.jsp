						...
						<div class="col-xs-12">
							...
							<!-- 所有 -->	
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="coursenumber"  id="form-field-1"  class="js_coursenumber col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name"  id="form-field-1"  class="js_coursename col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="credit"  id="form-field-1"  class="js_credit col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="space-4"></div>
...
<!-- 												</div> -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="schooltime"  id="form-field-1"  class="js_schooltime col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="address"  id="form-field-1"  class="js_address col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="numberlimit"  id="form-field-1"  class="js_numberlimit col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="space-4"></div>
